...
export const modelReleases: ModelRelease[] = [
  // 2024
  { id: 'llama-3.3-70b', date: '2024-12-06', provider: 'Meta', name: 'Llama 3.3 70B', params: '70B dense', context: '128K', license: 'Llama License', notable: 'Open-weight, instruction-tuned', category: 'open-source' },
  { id: 'phi-4', date: '2024-12-12', provider: 'Microsoft', name: 'Phi-4', params: '14B dense', context: '16K', license: 'MIT', notable: 'Synthetic data focus', category: 'small' },
  { id: 'deepseek-v3', date: '2024-12-25', provider: 'DeepSeek', name: 'DeepSeek-V3', params: '671B MoE (37B active)', context: '128K', license: 'MIT', notable: '$5.5M training cost', category: 'frontier' },

  // 2025 Q1
  { id: 'deepseek-r1', date: '2025-01-20', provider: 'DeepSeek', name: 'DeepSeek-R1', params: '671B MoE (37B active)', context: '128K', license: 'MIT', costInput: 0.55, costOutput: 2.19, notable: 'Open-source reasoning model', category: 'reasoning' },
  ...
  { id: 'o3-mini', date: '2025-01-31', provider: 'OpenAI', name: 'o3-mini', context: '200K', costInput: 1.10, costOutput: 4.40, notable: '3 effort levels', category: 'reasoning' },
  { id: 'gemini-2.0-flash', date: '2025-02-05', provider: 'Google', name: 'Gemini 2.0 Flash', context: '1M', costInput: 0.10, costOutput: 0.40, notable: 'Native multimodal', category: 'multimodal' },
  ...
  { id: 'claude-3.7-sonnet', date: '2025-02-24', provider: 'Anthropic', name: 'Claude 3.7 Sonnet', context: '200K', notable: 'First hybrid reasoning model, extended thinking', category: 'reasoning' },
  ...
  { id: 'gemini-2.5-pro', date: '2025-03-25', provider: 'Google', name: 'Gemini 2.5 Pro', context: '1M', costInput: 1.25, costOutput: 10.00, notable: 'First thinking Gemini, #1 Arena at launch', category: 'reasoning' },

  // 2025 Q2
  { id: 'llama-4-scout', date: '2025-04-05', provider: 'Meta', name: 'Llama 4 Scout', params: '109B MoE (17B active)', context: '10M', license: 'Llama License', notable: 'Open-weight MoE, multimodal', category: 'open-source' },
  { id: 'llama-4-maverick', date: '2025-04-05', provider: 'Meta', name: 'Llama 4 Maverick', params: '400B MoE (17B active)', context: '1M', license: 'Llama License', notable: 'Open-weight MoE, multimodal', category: 'open-source' },
  ...
  { id: 'qwen-3', date: '2025-04-29', provider: 'Alibaba', name: 'Qwen 3', params: '0.6B-235B MoE', context: '128K', license: 'Apache 2.0', notable: 'Hybrid thinking, 119 languages', category: 'open-source' },
  ...
  // 2025 Q4
  { id: 'claude-sonnet-4.5', date: '2025-09-29', provider: 'Anthropic', name: 'Claude Sonnet 4.5', context: '200K (1M beta)', costInput: 3.00, costOutput: 15.00, notable: 'SWE-bench 77.2%, AIME 100% w/ tools', category: 'coding' },
  ...
  { id: 'mistral-large-3', date: '2025-12-02', provider: 'Mistral', name: 'Mistral Large 3', params: '675B MoE (41B active)', context: '256K', license: 'Apache 2.0', notable: 'Multimodal', category: 'open-source' },
  ...
  { id: 'deepseek-v3.2', date: '2025-12-25', provider: 'DeepSeek', name: 'DeepSeek V3.2', params: '671B MoE (37B active)', context: '128K', license: 'MIT', costInput: 0.28, costOutput: 0.42, notable: 'AIME 96%, MIT license', category: 'open-source' },
  ...
  { id: 'claude-opus-4.6', date: '2026-02-05', provider: 'Anthropic', name: 'Claude Opus 4.6', context: '200K (1M beta, 128K output)', costInput: 5.00, costOutput: 25.00, notable: 'SWE-bench 80.8%, adaptive thinking', category: 'frontier' },
