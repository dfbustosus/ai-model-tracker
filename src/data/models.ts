...
export const modelReleases: ModelRelease[] = [
  ...
  { id: 'minimax-m2.5', date: '2026-02-11', provider: 'MiniMax', name: 'MiniMax M2.5', params: '230B MoE (10B active)', context: '196K', license: 'MIT (modified)', costInput: 0.27, costOutput: 0.95, notable: 'SWE-bench 80.2% (open-weight), 1/20th cost of Opus', category: 'open-source' },
  ...
  { id: 'cohere-tiny-aya', date: '2026-02-17', provider: 'Cohere', name: 'Tiny Aya', params: '3.35B', license: 'Open weights', notable: '70+ languages, offline on-device, multilingual', category: 'small' },
  ...
  { id: 'phi-4-reasoning-vision', date: '2026-03-04', provider: 'Microsoft', name: 'Phi-4-reasoning-vision', params: '15B', license: 'MIT', notable: 'Multimodal reasoning, mixed think/fast mode, 240 B200 GPUs for 4 days', category: 'multimodal', paperUrl: 'https://arxiv.org/abs/2603.03975' },
