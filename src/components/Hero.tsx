      ...
      <div className="relative pt-8 pb-12">
        <div className="text-center">
          ...
          <p className="text-sm text-surface-500 max-w-xl mx-auto mb-8">
            Compare 65+ models across benchmarks, pricing, and capabilities. From GPT-5.4 to Claude Opus 4.6 to Grok 4.20.
          </p>
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            <a
              href="https://twitter.com/intent/tweet?text=AI%20Model%20Tracker%20%E2%80%93%20Track%2065%2B%20AI%20models%20with%20benchmarks%2C%20pricing%2C%20and%20papers&url=https://dfbustosus.github.io/ai-model-tracker/"
              target="_blank"
