      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-primary-600 flex items-center justify-center" aria-hidden="true">
              <Cpu className="w-5 h-5 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold text-white leading-tight">AI Model Tracker</h1>
              <p className="text-[10px] text-surface-400 leading-tight">2025-2026 Landscape</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-surface-800 text-surface-300 hover:text-white hover:bg-surface-700 transition-all text-xs"
            >
